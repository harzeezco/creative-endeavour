        ...
        <ul className='flex flex-[1.3] flex-col gap-y-7'>
          {ourTrends.map((trend) => (
            <li>
              <div
                className={cn(
                  'group flex items-center justify-between gap-x-10 border-b-2  border-primary-50 pb-5',
              ...
              >
                ...
                >
                  <Link
                    className={cn(
                      'opacity-0 invisible transition-all duration-300 text-nowrap hover:underline text-[#181A2E] group-hover:visible group-hover:opacity-100',
                    )}
                    href={`/${locale}/blog`}
                  >
                    Read more
