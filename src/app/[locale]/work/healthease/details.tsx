...
function Details() {
  ...
  const title = t('healthease-con-title1');
  const desc = t('healthease-con-desc1');
  const label = t('healthease-con-label1');
  const title2 = t('healthease-con-title2');
  const desc2 = t('healthease-con-desc2');
  const label2 = t('healthease-con-label2');
  const title3 = t('healthease-con-title3');
  const desc3 = t('healthease-con-desc3');
  const label3 = t('healthease-con-label3');
