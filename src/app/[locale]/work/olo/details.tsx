...
function Details() {
  ...
  const title = t('olo-con-title1');
  const desc = t('olo-con-desc1');
  const label = t('olo-con-label1');
  const title2 = t('olo-con-title2');
  const desc2 = t('olo-con-desc2');
  const label2 = t('olo-con-label2');
  const title3 = t('olo-con-title3');
  const desc3 = t('olo-con-desc3');
  const label3 = t('olo-con-label3');
      ...
      <div className='container'>
        ...
        <div className='mb-10 mt-7 grid grid-cols-2 justify-between gap-y-4 sm:grid-cols-3 md:grid-cols-4'>
          <div>
            ...
            <p className='text-xl text-black'>{t('olo-desc1')}</p>
          </div>
          <div>
            <h3
              className={cn(
