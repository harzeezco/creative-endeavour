...
function Details() {
  ...
  const title = t('sata-con-title1');
  const desc = t('sata-con-desc1');
  const label = t('sata-con-label1');
  const title2 = t('sata-con-title2');
  const desc2 = t('sata-con-desc2');
  const label2 = t('sata-con-label2');
  const title3 = t('sata-con-title3');
  const desc3 = t('sata-con-desc3');
  const label3 = t('sata-con-label3');
