...
function Details() {
  ...
  const title = t('pipelined-con-title1');
  const desc = t('pipelined-con-desc1');
  const label = t('pipelined-con-label1');
  const title2 = t('pipelined-con-title2');
  const desc2 = t('pipelined-con-desc2');
  const label2 = t('pipelined-con-label2');
  const title3 = t('pipelined-con-title3');
  const desc3 = t('pipelined-con-desc3');
  const label3 = t('pipelined-con-label3');
