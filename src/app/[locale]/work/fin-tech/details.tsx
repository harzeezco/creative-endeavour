...
function Details() {
  ...
  const title = t('fin-tech-con-title1');
  const desc = t('fin-tech-con-desc1');
  const label = t('fin-tech-con-label1');
  const title2 = t('fin-tech-con-title2');
  const desc2 = t('fin-tech-con-desc2');
  const label2 = t('fin-tech-con-label2');
  const title3 = t('fin-tech-con-title3');
  const desc3 = t('fin-tech-con-desc3');
  const label3 = t('fin-tech-con-label3');
